...
#    sub=paste("bsub -q week -J Gibbs", shortname, copy,"_",Ci,"[1] -o ~/LSFouts/Gibbs.out R CMD BATCH --vanilla --args --name=",
    ...
    sub=paste("sbatch --constraint=rhel8 -p general -J Gibbs", shortname, copy,"_",Ci,"[1]
-o ~/SLURMouts/Gibbs.out 
--wrap=\"R CMD BATCH --vanilla --args  --name=",  name," --isGibbs=",1," --replicate=\\\u0024LSB_JOBINDEX
 --copy=",copy," --Ci=",Ci," GibbsMC.R ",  name,"/Gibbs",Ci,"\\\u0024LSB_JOBINDEX.out\"", sep="") 
    system(sub) 
  }  
}
